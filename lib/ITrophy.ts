...
export let Trophies: Array<ITrophy> = new Array<ITrophy>(
    ...
    {
        id: TROPHY_IDS.JUMPING_JACK_FLASH,
    ...
    {
        id: TROPHY_IDS.THE_LONG_WAY_HOME,
    ...
    {
        id: TROPHY_IDS.THE_LONGER_WAY_HOME,
    ...
    {
        id: TROPHY_IDS.THE_LONGEST_WAY_HOME,
    ...
    {
        id: TROPHY_IDS.LIGHT_AT_THE_END,
